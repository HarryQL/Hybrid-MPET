...
system = {'Sim Params': {'profileType': lambda x:
                         check_allowed_values(x, ["CC", "CV", "CP", "CCsegments", "CVsegments", "CR", "CRsegments"]),
                         'Crate': Use(float),
                         Optional('power', default=None): Use(float),
                         Optional('1C_current_density', default=None): Use(float),
                         Optional('RESIS', default=None): Use(float),
                         ...
                         Optional('Npart2_c'): And(Use(int), lambda x: x >= 0),
          ...
          'Particles': {'mean_c': Use(float),
                        'stddev_c': Use(float),
                        Optional('mean2_c'): Use(float),
                        Optional('stddev2_c'): Use(float),
                        'mean_a': Use(float),
                        'stddev_a': Use(float),
                        'cs0_c': Use(float),
                        'cs0_1_c': Use(float),
...
electrode = {'Particles': {'type': lambda x: check_allowed_values(x,
             ...
             'Material': {'muRfunc': str,
                          ...
                          Optional('Omega_d', default=None): Use(float),
                          'kappa': Use(float),
                          'B': Use(float),
                          Optional('EvdW', default=None): Use(float),
                          'rho_s': Use(float),
                          Optional('rho_s2'): Use(float),
                          Optional('cap_ratio'): Use(float),
                          Optional('Cdl1', default=0): Use(float),
                          Optional('Cdl2', default=0): Use(float),
                          Optional('Cdl3', default=0): Use(float),
                          'D': Use(float),
                          Optional('D2', default=0): Use(float),
                          'Dfunc': str,
                          'sigmafunc': str,
             ...
             'Reactions': {'rxnType': str,
                           Optional('rxnType2'): str,
                           'k0': Use(float),
                           Optional('k1', default=0.): Use(float),
                           Optional('k2', default=0.): Use(float),
                           Optional('E_A', default=0.): Use(float),
                           'alpha': Use(float),
                           Optional('alpha2'): Use(float),
                           'lambda': Use(float),
                           'Rfilm': Use(float)}}
